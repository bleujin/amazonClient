...
/**
 * ACL for S3. Usage samples: Allow everyone to read: <code>
 * acl.allow(Acl.Group.GUEST, Acl.Permission.READ);
 * </code> Allow all authorized users to read and write: <code>
 * Acl.Permission[] rights = {Acl.Permission.READ, Acl.Permission.WRITE};
 * acl.allow(Acl.Group.AUTHORIZED, rights);
 * </code> Deny all (owner still has access to overwrite ACL): <code>
 * acl.denyAll();
 * </code>
 * 
