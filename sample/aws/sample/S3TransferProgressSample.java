...
/**
 * Demonstrates how to upload data to Amazon S3, and track progress, using a Swing progress bar.
 * <p>
...
public class S3TransferProgressSample {
	...
	private void createAmazonS3Bucket() {
		try {
			...
			JOptionPane.showMessageDialog(frame, "Unable to create a new Amazon S3 bucket: " + ace.getMessage(), "Error Creating Bucket", JOptionPane.ERROR_MESSAGE);
		}
	}
