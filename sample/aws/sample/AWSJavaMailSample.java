...
/**
 * This sample demonstrates how to make basic requests to the Amazon Simple Email Service using the the standard JavaMail API.
 * <p>
 * <b>Prerequisites:</b> You must have a valid Amazon Web Services developer account, and be signed up to use Amazon Simple Email Service. For more information on Amazon Simple Email Service, see http://aws.amazon.com/ses .
 * <p>
...
public class AWSJavaMailSample {
	...
	/*
	 * Important: Be sure to fill in an email address you have access to so that you can receive the initial confirmation email from Amazon Simple Email Service.
	 */
	private static final String TO = "bleujin@gmail.com";
	private static final String FROM = "bleujin@i-on.net";
	...
	public static void main(String[] args) throws IOException {
		 ...
		 */
		PropertiesCredentials credentials = new PropertiesCredentials(AWSJavaMailSample.class.getResourceAsStream("/AwsCredentials.properties"));
	...
	/**
	 * Sends a request to Amazon Simple Email Service to verify the specified email address. This triggers a verification email, which will contain a link that you can click on to complete the verification process.
	 * 
	 * @param ses
