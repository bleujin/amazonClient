...
public class Requests {
	...
	private void init() throws Exception {
		AWSCredentials credentials = new PropertiesCredentials(InlineGettingStartedCodeSampleApp.class.getResourceAsStream("/AwsCredentials.properties"));
	 ...
	 * 
	 * Note the AMI id may change after the release of this code sample, and it is important to use the latest. You can find the latest version by logging into the AWS Management console, and attempting to perform a launch. You will be presented with AMI options, one of which will be Amazon Linux. Simply use that AMI id.
	 */
	...
	public boolean areAnyOpen() {
		...
		try {
			...
			for (SpotInstanceRequest describeResponse : describeResponses) {
				System.out.println(" " + describeResponse.getSpotInstanceRequestId() + " is in the " + describeResponse.getState() + " state.");
